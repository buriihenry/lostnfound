    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">Register to
                ...
                <div class="col-md-4">
                    <form action="processor.php" method="post">
                        ...
                        Confirm password:
                        <input type="password" name="confirmpassword" placeholder="Reenter Password" class="form-control" required>
                        <input type="hidden" name="who" value="register"><br>
